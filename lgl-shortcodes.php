...
define('LGL_SHORTCODES_VERSION', '2.4.0'); // Update this version number with each release for cache busting.
...
?>
        ...
        public function register_shortcodes()
        {
            ...
            // New Mini Compare shortcodes
            add_shortcode('lgl_mini_compare', array($this, 'render_mini_compare_shortcode'));
        ...
        /**
         * Renders the mini compare shortcode HTML markup.
         * Retrieves the assigned Vehicle Comparison Page ID from settings to generate the permalink.
         *
         * @param array  $atts    The array of attributes passed by the user.
         * @param string $content The enclosed content between opening and closing shortcode tags, if any.
         * @return string         The compiled HTML string containing the mini compare link and icon.
         */
        public function render_mini_compare_shortcode($atts = [], $content = null)
        {
            $options = get_option('lgl_settings', array());
            ...
            <div class="lgl-mini-compare-wrapper">
                <a href="<?php echo esc_url($link_url); ?>" class="lgl-mini-compare-link" style="text-decoration: none; color: inherit;">
                    <div class="lgl-mini-compare-toggle lgl-mini-compare-toggle-trigger" role="button" tabindex="0">
