...
if (! class_exists('LGL_Shortcodes')) {
	...
	class LGL_Shortcodes
	{
		...
		public function render_lgl_search($atts)
		{
			...
			return $this->load_template($template_name, $attributes);
		}
		 ...
		 */
		private function load_template($template_name, $attributes)
		{
