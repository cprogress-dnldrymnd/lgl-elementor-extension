        ...
        <div class="bt-post--thumbnail">
            ...
            <div class="bt-post--icon-btn">
                <?php if (is_user_logged_in()) { ?>
                    ...
                    ?>
                    <a class="bt-icon-btn lgl-wishlist-btn <?php echo esc_attr($wishlist_class); ?>" href="#" data-id="<?php echo esc_attr($post_id); ?>" data-title="<?php echo get_the_title(esc_attr($post_id)); ?>">
