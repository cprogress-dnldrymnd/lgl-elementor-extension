...
<main id="lgl-primary" class="lgl-site-main single-lgl">
        ...
        <article <?php post_class('lgl-post'); ?>>
                        ...
                        <div class="lgl-post--gallery js-gallery-slider">
                            ...
                            <div class="swiper js-gallery-slider-for lgl-gallery-slider lgl-slider-for swiper-button-style swiper-button-style">
                                ...
                                <div class="swiper-button-next">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16"> <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"></path> </svg>
                                </div>
                                <div class="swiper-button-prev">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16"> <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"></path> </svg>
                                </div>
                            </div>
                            ...
                            <div class="lgl-sale-card">
                                ...
                                <?php if (!empty($sub_title)) { ?>
                                    <div class="lgl-sale-finance">
                                        <div class="lgl-finance-label"><?php echo esc_html($sub_title); ?></div>
                                    </div>
                                <?php } ?>
                            </div>
            ...
            <div class="lgl-post--tabs lgl-tabs lgl-tabs-js">
                <div class="lgl-tabs--tbnav">
                    ...
                    <?php if (!empty(get_the_content())) { ?><a href="#lgl_panel_desc" class="lgl-nav-item"><span><?php echo esc_html__('Description', 'lgl'); ?></span></a><?php } ?>
                    <?php if (!empty($feature)) { ?><a href="#lgl_panel_interior" class="lgl-nav-item"><span><?php echo esc_html__('Features', 'lgl'); ?></span></a><?php } ?>
                    <?php if (!empty($warranty)) { ?><a href="#lgl_panel_warranty" class="lgl-nav-item"><span><?php echo esc_html__('Warranty', 'lgl'); ?></span></a><?php } ?>
                </div>
                <div class="lgl-tabs--tbpanel">
                    <div id="lgl_panel_overview" class="lgl-panel-item lgl-panel-overview lgl-is-active">
                        <div class="lgl-panel-item--inner">
                            <h3 class="lgl-title-ss"><span><?php echo esc_html__('Key Information', 'lgl'); ?></span></h3>
                            <?php include LGL_SHORTCODES_PATH . 'templates/partials/lgl-meta.php'; ?>
                        </div>
                    </div>
                    <?php if (!empty(get_the_content())) { ?>
                        <div id="lgl_panel_desc" class="lgl-panel-item lgl-panel-desc">
                            <div class="lgl-panel-item--inner">
                                <h3 class="lgl-title-ss"><span><?php echo esc_html__('Description', 'lgl'); ?></span></h3>
                                <div class="lgl-content-ss"><?php the_content(); ?></div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <?php if (!empty($warranty)) { ?>
                        <div id="lgl_panel_warranty" class="lgl-panel-item lgl-panel-warranty">
                            <div class="lgl-panel-item--inner">
                                <h3 class="lgl-title-ss"><span><?php echo esc_html__('Warranty', 'lgl'); ?></span></h3>
                                <div class="lgl-content-ss"><?php echo wp_kses_post($warranty); ?></div>
                            </div>
                        </div>
                    <?php } ?>
                </div>
    ...
    <div class="lgl-additional-content">
        <?php
        if (isset($lgl_options['single_vehicle_content']) && !empty($lgl_options['single_vehicle_content'])) {
            echo do_shortcode($lgl_options['single_vehicle_content']);
        }
        ?>
    </div>
</main>
