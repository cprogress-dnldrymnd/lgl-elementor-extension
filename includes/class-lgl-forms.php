...
?>
	...
	public function save_finance()
	{
		...
		wp_redirect(admin_url('admin.php?page=lgl-finance-form&saved=1'));
		exit;
	}
	...
	public function save_enquiry()
	{
		...
		wp_redirect(admin_url('admin.php?page=lgl-enquiry-form&saved=1'));
		exit;
	}
	...
	public function save_reserve()
	{
		...
		wp_redirect(admin_url('admin.php?page=lgl-reserve-form&saved=1'));
		exit;
	}
